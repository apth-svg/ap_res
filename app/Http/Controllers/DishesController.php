...
class DishesController extends Controller
{
    ...
    public function store(DishCreateRequest $request)
    {
        ...
        return redirect('dish')->with('message','Dish Successfull Created');
    }
    ...
    public function update(Request $request, Dish $dish)
    {
        ...
        $dish->save();
        return redirect('dish')->with('message','Dish Successfull Updated');
    }
    ...
    {
        $dish->delete();
        return redirect('dish')->with('message','Dish Successfull Deleted');
    }
